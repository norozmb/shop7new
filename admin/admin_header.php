...
<head>
    ...
    <meta name="description" content="Sound Museo Admin Panel">
    <meta name="author" content="">
    <link rel="shortcut icon" href="./img/logo.PNG">
    <title>Sound Museo Admin</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
                <div class="sidebar-brand-icon ml-0">
                    <img src="./img/logo.PNG" class="w-50 rounded-circle ml-0" alt="">
                </div>
                Sound Museo
            </a>
            ...
            <li class="nav-item">
                ...
                <div id="order" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-border.html">View order</a>
                    </div>
                </div>
            </li>
            <hr class="sidebar-divider my-0">
            <li class="nav-item">
                ...
                <div id="customer" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="utilities-border.html">View customer</a>
                    </div>
                </div>
            </li>
